...
<nav class="navbar is-primary has-background-link-light"style="max-width:1200px;margin:auto">

    <div class="container">
      <div class="navbar-brand">
        <a href="index.php" class="navbar-item has-text-black">Bella
          Cosa</a>
    ...
    <div class="navbar-end">
      <div class="navbar-item">
        <div class="navbar-menu" id="navMenu">
          ...
          <a href="login.php" class="navbar-item">Login/Join</a>
        </div>
      </div>
    </div>
  </nav>
<div class="w3-top">
    ...
    <?php
        ...
        for ($page = 1; $page <= $number_of_page; $page++) {
            echo '<a href = "index.php?pageno=' . $page . '">&nbsp&nbsp' . $page . ' </a>';
        }
